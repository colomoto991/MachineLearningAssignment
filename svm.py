...
train_score = model.score(train_data,train_label.ravel())
print("trainingset：",train_score)
test_score = model.score(test_data,test_label.ravel())
...
fpr,tpr,threshold = roc_curve(test_label, predict_label) ###计算真正率和假正率
